      ...
      <div className="page">
        <div className="container">
          <div id="accessibility-page">
            <h1>boshena.co.uk Accessibility Statement</h1>

            <p>Updated: December 2019.</p>

            <h2>General</h2>
            <p>
              boshena.co.uk strives to ensure that its content is accessible to
              people with disabilities. boshena.co.uk has invested a significant
            ...
            <h2>Accessibility on boshena.co.uk</h2>
            <p>
              boshena.co.uk makes available the{" "}
              <a
              ...
              allows boshena.co.uk to improve its compliance with the Web
              Content Accessibility Guidelines (WCAG 2.1).
            </p>
            <h2>Enabling the Accessibility Menu</h2>
            <p>
              The boshena.co.uk accessibility menu can be enabled by clicking
              the accessibility menu icon that appears on the corner of the
              page. After triggering the accessibility menu, please wait a
              moment for the accessibility menu to load in its entirety.
            </p>
            <h2>Disclaimer</h2>
            <p>
              boshena.co.uk continues its efforts to constantly improve the
              ...
              <br />
              <br />
              Despite the efforts to make all pages and content on boshena.co.uk
              fully accessible, some content may not have yet been fully adapted
              to the strictest accessibility standards. This may be a result of
              not having found or identified the most appropriate technological
              solution.
            </p>
            <h2>Here For You</h2>
            <p>
              If you are experiencing difficulty with any content on
              boshena.co.uk or require assistance with any part of my site,
